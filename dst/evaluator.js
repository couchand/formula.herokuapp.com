...
(function() {
  var Evaluator, FormulaVisitor, Unbound, evaluate, funcs, getComparator, unbound,
  ...
  Evaluator = (function(_super) {
    ...
    Evaluator.prototype.visitComparison = function(node) {
      return this.visitInfixExpression(node, getComparator(node.comparator));
    };

    Evaluator.prototype.visitAddition = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a + b;
      });
    };

    Evaluator.prototype.visitSubtraction = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a - b;
      });
    };

    Evaluator.prototype.visitMultiplication = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a * b;
      });
    };

    Evaluator.prototype.visitDivision = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a / b;
      });
    };

    Evaluator.prototype.visitConcatenation = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a + b;
      });
    };

    Evaluator.prototype.visitConjunction = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a && b;
      });
    };

    Evaluator.prototype.visitDisjunction = function(node) {
      return this.visitInfixExpression(node, function(a, b) {
        return a || b;
      });
    };
  ...
  Unbound = (function(_super) {
    ...
    Unbound.prototype.visitComparison = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitAddition = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitSubtraction = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitMultiplication = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitDivision = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitConcatenation = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitConjunction = function(node) {
      return this.visitInfixExpression(node);
    };

    Unbound.prototype.visitDisjunction = function(node) {
      return this.visitInfixExpression(node);
    };
