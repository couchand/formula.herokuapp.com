...
case 1: return $$[$0-1]; 
break;
case 3: this.$ = new node.FunctionCall( $$[$0-2], [] ); 
break;
case 4: this.$ = new node.FunctionCall( $$[$0-3], $$[$0-1] ); 
break;
case 5: this.$ = [$$[$0]]; 
break;
...
break;
case 21: this.$ = new node.Multiplication( $$[$0-2], $$[$0] ); 
break;
case 22: this.$ = new node.Division( $$[$0-2], $$[$0] ); 
break;
case 23: this.$ = new node.Addition( $$[$0-2], $$[$0] ); 
break;
case 24: this.$ = new node.Subtraction( $$[$0-2], $$[$0] ); 
break;
case 25: this.$ = new node.Concatenation( $$[$0-2], $$[$0] ); 
break;
case 26: this.$ = new node.Conjunction( $$[$0-2], $$[$0] ); 
break;
case 27: this.$ = new node.Disjunction( $$[$0-2], $$[$0] ); 
break;
case 28: this.$ = new node.Comparison( $$[$0-1], $$[$0-2], $$[$0] ); 
break;
case 40: this.$ = new node.Parens( $$[$0-1] ); 
break;
case 41: this.$ = new node.Reference( $$[$0] ); 
break;
case 42: this.$ = [$$[$0]]; 
break;
case 43: this.$ = $$[$0-2]; this.$.push( $$[$0] ); 
break;
case 45: this.$ = new node.IntegerLiteral( $$[$0] ); 
break;
case 49: this.$ = new node.DecimalLiteral( $$[$0-2], $$[$0] ); 
break;
case 50: this.$ = new node.StringLiteral( $$[$0].substring(1,$$[$0].length-1) ); 
break;
}
},
